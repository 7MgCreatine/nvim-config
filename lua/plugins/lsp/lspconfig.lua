return {
    ...
    dependencies = {
        ...
        { "Hoffs/omnisharp-extended-lsp.nvim" }, -- OmniSharp-Erweiterungen
    },
    config = function()
        ...
        -- import omnisharp_extended plugin
        local omnisharp_extended = require("omnisharp_extended")

        local keymap = vim.keymap -- for conciseness

        -- Keymaps für OmniSharp Extended Commands
        ...
        vim.api.nvim_create_autocmd("LspAttach", {
            ...
            callback = function(ev)
                ...
                -- Additional mappings for diagnostics and hover
        ...
        mason_lspconfig.setup_handlers({
            ...
            -- OmniSharp configuration with extended handlers
            ["omnisharp"] = function()
